...
This tutorial describes how to use the Assemble Contigs from Reads and Annotate Microbial Contigs apps to assemble and annotate a bacterial or archaeal genome in the Narrative Interface and then browse the results.
...
You can find out more about this data object by mousing over the record in the Data Panel and clicking the “…” that appears. An expanded view of the data will open, as shown. Please see the [_Explore Data_](../../getting-started/narrative-user-guide/explore-data.md) section of the Narrative User Interface Guide for more information.
