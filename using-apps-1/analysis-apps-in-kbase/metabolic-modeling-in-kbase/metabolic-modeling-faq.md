...
* [What does the KBase gapfilling app do?](https://kbase.us/metabolic-modeling-faq/#What-does-the-KBase-gapfilling-method-do)
* [How does the underlying gapfilling algorithm work \(i.e., what kind of programming formulation does it use\)?](https://kbase.us/metabolic-modeling-faq/#How-does-the-underlying-gapfilling-algorithm-work)
* [What is the solver used in your gapfill optimization?](https://kbase.us/metabolic-modeling-faq/#What-is-the-solver-used-in-your-Gapfill-optimization)
* [How do I choose a media condition for gapfilling, and what is the default media used?](https://kbase.us/metabolic-modeling-faq/#How-do-I-choose-a-media-condition-for-gapfilling)
* [What is “complete” media?](https://kbase.us/metabolic-modeling-faq/#What-is-complete-media)
* [How can I see the compounds comprising a media used in gapfilling?](https://kbase.us/metabolic-modeling-faq/#How-can-I-see-the-compounds-comprising-a-media-used-in-gapfilling)
* [Which reactions were added in the gapfilling process and why were they added?](https://kbase.us/metabolic-modeling-faq/#Which-reactions-were-added-in-the-gapfilling-process-and-why-were-they-added)
* [When I import a metabolic model, how do I associate it with a genome?](https://kbase.us/metabolic-modeling-faq/#Associate-genome-with-imported-model)
* [When viewing a model, what do the compartment IDs mean?](https://kbase.us/metabolic-modeling-faq/#When-viewing-a-model-what-do-the-compartment-IDs-mean)
* [After merging models, why do I end up with one or two more compartments?](https://kbase.us/metabolic-modeling-faq/#Why-do-I-end-up-with-one-or-two-more-compartments)
* [What should I know about performing metabolic modeling on plants?](https://kbase.us/metabolic-modeling-faq/#What-should-I-know-about-performing-metabolic-modeling-on-plants)
* [How can I download all the biochemical compounds or reactions in KBase, as well as linked information such as Enzyme Commission \(E.C.\) Numbers?](https://kbase.us/metabolic-modeling-faq/#How-can-I-download-all-the-biochemical-compounds-and-reactions-in-KBase)
* [Do the media in KBase include sources other than carbon \(e.g., nitrogen, phosphorus, sulfur\)?](https://kbase.us/metabolic-modeling-faq/#Do-the-media-in-KBase-include-sources-other-than-carbon)
* [How can I specify my own media?](https://kbase.us/metabolic-modeling-faq/#How-can-I-specify-my-own-media)
* [How are units of flux measured within the media?](https://kbase.us/metabolic-modeling-faq/#How-are-units-of-flux-measured-within-the-media)
* [What is the unit of measurement for the estimated biomass from a metabolic model?](https://kbase.us/metabolic-modeling-faq/#What-is-the-unit-of-measurement-for-the-estimated-biomass-from-a-metabolic-model)
* [How is media data structured in KBase?](https://kbase.us/metabolic-modeling-faq/#How-is-media-data-structured-in-KBase)
* [What is the function of the .gffba file? What is the difference between the .gffba output and Flux Balance Analysis output?](https://kbase.us/metabolic-modeling-faq/#What-is-the-function-of-the-gffba-file)
* [How can I determine if my metabolic model will grow in a certain media?](https://kbase.us/metabolic-modeling-faq/#How-can-I-determine-if-my-metabolic-model-will-grow-in-a-certain-media)
* [After running flux balance analysis, what does the sign of a reaction flux mean?](https://kbase.us/metabolic-modeling-faq/#After-running-flux-balance-analysis-what-does-the-sign-of-a-reaction-flux-mean)
* [What do the various reaction classifiers mean?](https://kbase.us/metabolic-modeling-faq/#What-do-the-various-reaction-classifiers-mean)
* [Can I customize the flux boundaries of reactions in my model?](https://kbase.us/metabolic-modeling-faq/#Can-I-customize-the-flux-boundaries-of-reactions-in-my-model)
* [How can I edit my media or metabolic model \(add or delete reactions, compounds, or biomass\)?](https://kbase.us/metabolic-modeling-faq/#How-can-I-edit-my-media-or-metabolic-model)
* [Why did gapfilling fail for a model containing a custom media or custom biomass reaction? What can I do about it?](https://kbase.us/metabolic-modeling-faq/#Why-did-gapfilling-fail-for-a-model-containing-a-custom-media-or-custom-biomass-reaction)
* [What if my source and translated metabolic models are the same after running the “Propagate Genome-scale Model to Close Genome” app?](https://kbase.us/metabolic-modeling-faq/#What-if-my-source-and-translated-metabolic-models-are-the-same)
* [What do the “Prediction class” values mean in the output table generated by the “Simulate Growth on Phenotype Data” app?](https://kbase.us/metabolic-modeling-faq/#What-do-the-Prediction-class-values-mean)
* [Why did I get false negatives after simulating growth, and what can I do about it?](https://kbase.us/metabolic-modeling-faq/#Why-did-I-get-false-negatives-after-simulating-growth)

For more information—including descriptions of the underlying algorithms, inputs, and outputs—see the [app](https://kbase.us/apps/) detail pages linked below.  
