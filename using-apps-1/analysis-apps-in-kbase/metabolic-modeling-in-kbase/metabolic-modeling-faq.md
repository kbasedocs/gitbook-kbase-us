...
* [What does the KBase gapfilling app do?](metabolic-modeling-faq.md#q-what-does-the-kbase-gapfilling-app-do)
* [How does the underlying gapfilling algorithm work \(i.e., what kind of programming formulation does it use\)?](metabolic-modeling-faq.md#q-how-does-the-underlying-gapfilling-algorithm-work-i-e-what-kind-of-programming-formulation-does-it-use)
* [What is the solver used in your gapfill optimization?](metabolic-modeling-faq.md#q-what-is-the-solver-used-in-your-gapfill-optimization)
* [How do I choose a media condition for gapfilling, and what is the default media used?](metabolic-modeling-faq.md#q-how-do-i-choose-a-media-condition-for-gapfilling-and-what-is-the-default-media-used)
* [What is “complete” media?](metabolic-modeling-faq.md#q-what-is-complete-media)
* [How can I see the compounds comprising a media used in gapfilling?](metabolic-modeling-faq.md#q-how-can-i-see-the-compounds-comprising-a-media-used-in-gapfilling)
* [Which reactions were added in the gapfilling process and why were they added?](metabolic-modeling-faq.md#q-which-reactions-were-added-in-the-gapfilling-process-and-why-were-they-added)
* [When I import a metabolic model, how do I associate it with a genome?](metabolic-modeling-faq.md#q-when-i-import-a-metabolic-model-how-do-i-associate-it-with-a-genome)
* [When viewing a model, what do the compartment IDs mean?](metabolic-modeling-faq.md#q-when-viewing-a-model-what-do-the-compartment-ids-mean)
* [After merging models, why do I end up with one or two more compartments?](metabolic-modeling-faq.md#q-after-merging-models-why-do-i-sometimes-end-up-with-one-or-two-more-compartments)
* [What should I know about performing metabolic modeling on plants?](metabolic-modeling-faq.md#q-what-should-i-know-about-performing-metabolic-modeling-on-plants)
* [How can I find and download all the biochemical compounds and reactions in KBase, as well as linked information such as Enzyme Commission \(E.C.\) Numbers?](metabolic-modeling-faq.md#q-how-can-i-find-and-download-all-the-biochemical-compounds-and-reactions-in-kbase-as-well-as-linked-information-such-as-enzyme-commission-e-c-numbers)
* [Do the media in KBase include sources other than carbon \(e.g., nitrogen, phosphorus, sulfur\)?](metabolic-modeling-faq.md#q-do-the-media-in-kbase-include-sources-other-than-carbon-e-g-nitrogen-phosphorus-sulfur)
* [How can I specify my own media?](metabolic-modeling-faq.md#q-how-can-i-specify-my-own-media)
* [How are units of flux measured within the media?](metabolic-modeling-faq.md#q-how-are-units-of-flux-measured-within-the-media)
* [What is the unit of measurement for the estimated biomass from a metabolic model?](metabolic-modeling-faq.md#q-what-is-the-unit-of-measurement-for-the-estimated-biomass-from-a-metabolic-model)
* [How is media data structured in KBase?](metabolic-modeling-faq.md#q-how-is-media-data-structured-in-kbase)
* [What is the function of the .gffba file? What is the difference between the .gffba output and Flux Balance Analysis output?](metabolic-modeling-faq.md#q-what-is-the-function-of-the-gffba-file-what-is-the-difference-between-the-gffba-output-and-flux-balance-analysis-output)
* [How can I determine if my metabolic model will grow in a certain media?](metabolic-modeling-faq.md#q-how-can-i-determine-if-my-metabolic-model-will-grow-in-a-certain-media)
* [After running flux balance analysis, what does the sign of a reaction flux mean?](metabolic-modeling-faq.md#q-after-running-flux-balance-analysis-what-does-the-sign-of-a-reaction-flux-mean)
* [What do the various reaction classifiers mean?](metabolic-modeling-faq.md#q-what-do-the-various-reaction-classifiers-mean)
* [Can I customize the flux boundaries of reactions in my model?](metabolic-modeling-faq.md#q-can-i-customize-the-flux-boundaries-of-reactions-in-my-model)
* [How can I edit my media or metabolic model \(add or delete reactions, compounds, or biomass\)?](metabolic-modeling-faq.md#q-how-can-i-edit-my-media-or-metabolic-model-add-or-delete-reactions-compounds-or-biomass)
* [Why did gapfilling fail for a model containing a custom media or custom biomass reaction? What can I do about it?](metabolic-modeling-faq.md#q-why-did-gapfilling-fail-for-a-model-containing-a-custom-media-or-custom-biomass-reaction-what-can-i-do-about-it)
* [What if my source and translated metabolic models are the same after running the “Propagate Genome-scale Model to Close Genome” app?](metabolic-modeling-faq.md#q-what-if-my-source-and-translated-metabolic-models-are-the-same-after-running-the-propagate-genome-scale-model-to-close-genome-app)
* [What do the “Prediction class” values mean in the output table generated by the “Simulate Growth on Phenotype Data” app?](metabolic-modeling-faq.md#q-what-do-the-prediction-class-values-mean-in-the-output-table-generated-by-the-simulate-growth-on-phenotype-data-app)
* [Why did I get false negatives after simulating growth, and what can I do about it?](metabolic-modeling-faq.md#q-why-did-i-get-false-negatives-after-simulating-growth-and-what-can-i-do-about-it)

For more information—including descriptions of the underlying algorithms, inputs, and outputs—see the [app](../) detail pages linked below.  
...
* [Tutorial](https://kbase.us/run-flux-balance-analysis-method/)
...
* [Tutorial](https://kbase.us/simulate-growth-on-phenotype-data-method/)
...
To find out which transport reactions are available when running FBA using Complete media, you can then download the [biochemistry database](https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry) and browse the spreadsheet.
...
In addition to the default complete media, KBase provides more than 500 media conditions you can use for gapfilling. The [Narrative Interface User Guide](../../../getting-started/narrative-user-guide/) describes how to add these media and other data to your Narrative. You can also [upload your own custom media condition](https://kbase.us/data-upload-download-guide/media/).
...
Note that gapfilling runs can be stacked, meaning that multiple gapfilling solutions are incorporated into the same model, one after the other. In other words, if you gapfill on Complete media first \(i.e., don’t specify a media, so it defaults to Complete\), gapfilling will add all reactions needed to get the model to grow assuming it can transport all compounds for which a transporter is available in the [KBase biochemistry database](https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry). If you then gapfill the same \(already gapfilled once\) model on minimal media, the model will only add any additional reactions needed to grow on the minimal media.
...
The [tutorial for the Reconstruct Genome-scale Metabolic Model app](https://kbase.us/reconstruct-genome-scale-metabolic-model-app/) explores the differences between two gapfilled solutions: one generated on complete media, and one generated on minimal media.
...
The biochemistry compounds and reactions can be downloaded from [https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry](https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry). This spreadsheet includes the EC numbers. You can also consult the [Enzyme database](http://enzyme.expasy.org/) to see a description of each type of characterized enzyme that has an EC number.
...
You can generate and import your own media file by specifying the biochemical compounds found in a particular growth environment. Go to [https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry](https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry) to see a list of all the biochemical compounds in KBase and find the IDs for those you wish to include in your custom media.
...
Please see the “Media” section of the Data Guide \([https://kbase.us/data-upload-download-guide/media/](https://kbase.us/data-upload-download-guide/media/)\) for more information on how to configure your media file.
...
For example, the following table shows a portion of the “Reaction fluxes” tab from the output of the “[Run Flux Balance Analysis](https://kbase.us/run-flux-balance-analysis-method/)” app. Here, the positive flux in the “Flux” column indicates that rxn00543 is proceeding from left to right—that is, ethanol is being oxidized to acetaldehyde.
...
Also, in the “[Run Flux Balance Analysis](https://kbase.us/run-flux-balance-analysis-method/)” app, you can change the “bounds” on a specific reaction to whatever you want using the “Custom flux bounds” field under advanced options:
...
Try our [Edit Media](https://narrative.kbase.us/#catalog/apps/fba_tools/edit_media/release) or [Edit Metabolic Model](https://narrative.kbase.us/#catalog/apps/fba_tools/edit_metabolic_model/06cbf0f35c455f877bf9bb4a7bd5bc18cdb74de8) apps! These apps and their documentation are still in development. Please [let us know](https://kbase.us/contact-us/) if you have questions or suggestions.
...
If the compound is not in the model, it may be rare or uncommon. Check KBase’s reference biochemistry database  \([https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry](https://github.com/ModelSEED/ModelSEEDDatabase/tree/master/Biochemistry)\) to ensure that:
...
We welcome your [feedback](https://kbase.us/contact-us/) on the information provided in this FAQ. If you have a question about the metabolic modeling tools and data in KBase that is not answered here, or the answer provided didn’t work for you, please [contact us](https://kbase.us/contact-us/).
