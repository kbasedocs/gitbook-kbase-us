...
Flowchart of [Apps used in Metabolic Modeling](../../apps/analysis/metabolic-modeling.md).
...
The flowchart above shows KBase’s metabolic modeling tools \(green\) as well as some other analysis tools. Check the [App Catalog](../../apps/catalog.md) for the latest set of metabolic modeling analysis tools \(Apps\).
