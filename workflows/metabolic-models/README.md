...
Flowchart of [Apps used in Metabolic Modeling](../../using-apps/analysis-apps/metabolic-modeling.md).
...
The flowchart above shows KBase’s metabolic modeling tools \(green\) as well as some other analysis tools. Check the [App Catalog](../../using-apps/app-catalog.md) for the latest set of metabolic modeling analysis tools \(Apps\).
